...
@section('title', isset($title) ? $title : 'Contact Us | The Future is Right Here')
                ...
                <form action="https://gratech.coevs.com/contact" method="post">
                    <input type="hidden" name="_token" value="ThLEl1n9zDtgHXXiIqwUhSLPfHSsMHGZ6HFrGLKw" autocomplete="off">							<div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <input class="bg-transparent bor" name="email" id="email" type="email" required="" placeholder="Your Email">
                        </div>
                    </div>
                    <div class="text-area">
                        <label for="massage">Your Message*</label>
                        <textarea class="bg-transparent bor" name="massage" id="massage" required="" placeholder="Write Message"></textarea>
                    </div>
                    <div class="btn-two">

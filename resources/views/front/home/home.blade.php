					...
					<div class="container">
						<div class="banner-two__content text-center">
							...
							<h1 data-animation="fadeInUp" data-delay=".5s" class="text-white">
								Get Your Best Technology Related Consultancy from Us
							</h1>
							...
							<a data-animation="fadeInUp" data-delay="1s" href="/about"
							   class="btn-one mt-50">Explore More <i class="fa-regular fa-arrow-right-long"></i></a>
						</div>
					</div>
				</div>
											<div class="swiper-slide">
...
</section>			<section class="choose-area sub-bg pt-120 pb-120">
			...
			<div class="col-lg-6">
					...
					<h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
						<svg class="me-1" width="20" height="12" viewBox="0 0 20 12" fill="none"
							...
							<path
								...
								fill="#EB2026" mask="url(#path-2-inside-1_682_455)" />
						</svg>
				...
				<div class="progress-area wow fadeInDown mt-40" data-wow-delay="00ms"
					...
					<div class="progress__title mb-10">
						...
						<span><span class="progress-count">86</span>%</span>
					</div>
					<div class="progress">
...
</section>			<section class="team-area pt-120 pb-120">
	<div class="container">
			...
			<div class="col-lg-7 mt-60">
				...
				<div class="faq__item">
					<div class="accordion" id="accordionExample">
																			<div class="accordion-item wow fadeInDown shadow border-none  dark-mode " data-wow-delay="100ms"
						     data-wow-duration="1500ms">
							<h2 class="accordion-header" id="headingOne60">
							...
							<div id="collapseOne60" class="accordion-collapse collapse  show  "
								...
								<div class="accordion-body">
									<p> It is a long established fact that a reader be distracted by the readable content of a page when looking a its layout. Many desktop publishing packages and web page editors now use Lorem Ipsum</p>
																			...
																			<div class="accordion-item wow fadeInDown shadow border-none  dark-mode " data-wow-delay="200ms"
						     data-wow-duration="1500ms">
							<h2 class="accordion-header" id="headingOne61">
							...
							<div id="collapseOne61" class="accordion-collapse collapse  "
								...
								<div class="accordion-body">
									<p> It is a long established fact that a reader be distracted by the readable content of a page when looking a its layout. Many desktop publishing packages and web page editors now use Lorem Ipsum</p>
																			...
																			<div class="accordion-item wow fadeInDown shadow border-none  dark-mode " data-wow-delay="300ms"
						     data-wow-duration="1500ms">
							<h2 class="accordion-header" id="headingOne62">
								<button class="accordion-button  collapsed " type="button" data-bs-toggle="collapse"
							...
							<div id="collapseOne62" class="accordion-collapse collapse  "
								...
								<div class="accordion-body">
									<p> It is a long established fact that a reader be distracted by the readable content of a page when looking a its layout. Many desktop publishing packages and web page editors now use Lorem Ipsum</p>
																			...
																			<div class="accordion-item wow fadeInDown shadow border-none  dark-mode " data-wow-delay="400ms"
						     data-wow-duration="1500ms">
		...
		<div class="d-flex gap-4 flex-wrap align-items-center justify-content-between mb-60">
			<div class="section-header">
				<h5 class="wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
					<svg class="me-1" width="20" height="12" viewBox="0 0 20 12" fill="none"
					     xmlns="http://www.w3.org/2000/svg">
						<rect x="0.75" y="0.747803" width="18.5" height="10.5" rx="5.25" stroke="#EB2026"
						      stroke-width="1.5"/>
						...
						<path
							...
							fill="#EB2026" mask="url(#path-2-inside-1_1120_297)"/>
					</svg>
...
</section>			<section class="testimonial-two-area pb-120">
	<div class="container">
...
</section>			<section class="blog-two-area pb-120">
	<div class="container">
		<div class="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
			<div class="section-header">
				<h5 class="wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
					<svg class="me-1" width="20" height="12" viewBox="0 0 20 12" fill="none"
					     xmlns="http://www.w3.org/2000/svg">
						<rect x="0.75" y="0.748047" width="18.5" height="10.5" rx="5.25" stroke="#EB2026"
						      stroke-width="1.5"/>
						...
						<path
							...
							fill="#EB2026" mask="url(#path-2-inside-1_1120_300)"/>
					</svg>
					Blog &amp; news
				</h5>
				<h2 class="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Explore Blogs and News</h2>
			</div>
			<a href="/blog" class="btn-one wow fadeInUp" data-wow-delay="200ms"
			   data-wow-duration="1500ms">View All News <i class="fa-regular fa-arrow-right-long"></i></a>
		</div>
...
</section>			<section class="quote-area">
	<div class="container">
